...
```{r}
canes <- read_csv("https://raw.githubusercontent.com/libjohn/workshop_flexdashboards/master/data/hurricanes.csv") %>% 
...
1. [Easy interactive](../11_exercise_timeseries.Rmd) ggplot2 via `plotlly::ggplotly()` -- [**answers**](../11_exercise_timeseries_answers.Rmd)

1. [Linked Brushing via Shared Data](../12_exercise_crosstalk_map.Rmd) --  [**answers**](../12_exercise_crosstalk_map_answers.Rmd)

1. [Putting it all together](../13_exercise_all_together.Rmd) (layouts, shared data, filters, gauges, value boxes) 
...
<!-- Image Credit:  https://www.r-graph-gallery.com/cartogram/ -->




<!-- Annimate a plot with [gganimate](https://gganimate.com/).  -->
